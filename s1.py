...
class student:
        def __init__(self,first_window):
            ...
            self.frame = Frame(self.window, bg = 'powder blue', width=700,height=400)

            self.label = Label(self.frame,text='Student User',bg='powder blue',font=('Georgia',30,'bold'))
            self.label.place(x=20,y=20,width=400,height=50)

            self.label_title = Label(self.frame, text='TITLE',bg='powder blue',font=('Georgia',14,'bold'))
            self.label_title.place(x=20,y=100,width=100,height=50)

            self.label_year = Label(self.frame, text='YEAR',bg='powder blue',font=('Georgia',14,'bold'))
            self.label_year.place(x=20,y=150,width=100,height=30)

            self.label_author = Label(self.frame, text='AUTHOR',bg='powder blue',font=('Georgia',14,'bold'))
            self.label_author.place(x=350,y=100,width=100,height=30)

            self.label_isbn = Label(self.frame, text='ISBN',bg='powder blue',font=('Georgia',14,'bold'))
        ...
        def issue_command(self):
            try:
                ...
                value = self.listbox.get(selected_tuple[0])
                if len(value) < 4:
                    raise ValueError("Selected item does not have enough data")
