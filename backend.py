...
def issue():
    conn = mysql.connect(host="localhost", user="root", password="********", database="books", auth_plugin="mysql_native_password")
    cur = conn.cursor()
...
def request_insert(title, author, year, isbn):
    conn = mysql.connect(host="localhost", user="root", password="********", database="request", auth_plugin="mysql_native_password")
    cur = conn.cursor()
